    ...
    const handelLogin = event => {
        ...
        login(email, password)
            .then(result => {
                ...
                // get jwt token 
                fetch('https://ticket-booking-wesite-server.vercel.app/jwt', {
                    method: 'POST',
                    headers: {
        ...
        <div className='flex justify-center my-10 mx-2'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-300 text-gray-900">
                ...
                <form onSubmit={handelLogin} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <button className="block w-full p-3 text-center font-bold rounded-sm text-gray-900 bg-info">Sign in</button>
                </form>
